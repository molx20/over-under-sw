...
def get_team_turnover_vs_defense_pressure(team_id: int, season: str = '2025-26') -> Optional[Dict]:
    ...
    try:
        ...
        # Step 2: Get opponent turnover forcing ranks for all games
        ...
        # Step 3: Group games by pressure tier and location
        splits = {
        ...
        for game in games:
            ...
            splits[pressure_tier][location_key].append(game['team_turnovers'])
